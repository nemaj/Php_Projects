...
$res = $conn->query("SELECT * FROM pupils WHERE parent_id='$parentId' AND last_name LIKE '%$search%' OR parent_id='$parentId' AND first_name LIKE '%$search%' OR parent_id='$parentId' AND middle_name LIKE '%$search%'");
